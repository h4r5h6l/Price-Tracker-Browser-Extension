...
def save_products(products, products_path, history_path):
    ...
    for p in products:
        ...
        if asin not in all_history:
            all_history[asin] = {}
        all_history[asin][time_stamp] = price
        # else:
        # Update title/rating in case they changed
...
{
  "B0DNWTC57N": [
    {"price": 799.99, "scraped_at": "2026-07-16T14:32:07"},
    {"price": 789.99, "scraped_at": "2026-07-17T09:15:22"},
    {"price": 774.50, "scraped_at": "2026-07-18T09:12:03"}
  ]
}
"""
